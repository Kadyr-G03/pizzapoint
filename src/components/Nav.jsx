...
function Nav() {
  ...
  const scrollToSection = (id) => {
    ...
    return (
      <>
        <span onClick={handleClick} className="cursor-pointer md:hidden border-[0.5px] rounded-[5px] border-stone-400 bg-stone-200 z-30 fixed w-[30px] h-[30px] rounded-[10px] my-[10px] mx-[15px] top-0 right-0 flex items-center justify-center transition-all">
